  ...
  <div class="w-full max-w-md">
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
      <div class="text-center mb-8">
        ...
        <p class="text-slate-600 dark:text-slate-400 mt-2">Accédez à votre compte</p>
      </div>
      ...
      <form method="post" class="space-y-4">
        ...
        <button type="submit" class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors mt-6">
          Se connecter
        </button>
      </form>
      ...
      <div class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
        <p class="text-sm text-slate-600 dark:text-slate-400 text-center">
          ...
          <a href="index.php?page=auth&action=register" class="text-blue-600 dark:text-blue-400 hover:underline font-semibold">Créer un compte</a>
        </p>
      </div>
    </div>
  </div>
