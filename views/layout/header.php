  ...
  <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex justify-between items-center">
      ...
      <div class="flex items-center gap-4">
        <button class="dark-toggle p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-all duration-300" title="Basculer le mode sombre">
          <svg class="w-5 h-5 text-indigo-600 dark:hidden" fill="currentColor" viewBox="0 0 20 20"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
